...
const nodemailer = require('nodemailer'); // Añadir esta línea
    ...
    if (option === 'multimedia') {
      ...
      if (vuforiaResponse.status === 201) {
        ...
        const mailOptions = {
          ...
          to: process.env.ADMIN_EMAIL, // Dirección de correo electrónico del administrador
          subject: 'Nueva solicitud de modelado en 3D',
          text: `
            Nombre: ${name}
            Correo: ${email}
            Teléfono: ${phone}
