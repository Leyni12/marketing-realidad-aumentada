...
const Contactol = () => {
  ...
  useEffect(() => {
    switch (option) {
          ...
          <>
            ...
            <div>
              ...
              <ol>
                ...
                <li>
                  <strong>Video:</strong> Debe estar en formato compatible con la plataforma (MP4 recomendado), con una duración máxima de 15 minutos y resolución de al menos 720p.</li>
              </ol>
            </div>
          </>
        );
        ...
        setLeftText(
          <>
            ...
            <div className="instruction-list">
              <h3>Instrucciones:</h3>
              <ol>
                <li><strong>Imagen de la etiqueta del producto:</strong> Asegúrate de que la imagen sea clara y esté bien iluminada para una detección precisa.</li>
      ...
      default:
        setLeftTitle('Personaliza tus etiquetas');
        setLeftText(
          <>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {option === '3d' && (
                    <>
                      ...
                      <div className="input-group">
                        <label>Describa su idea sobre el modelado en 3D</label>
                        <textarea
                          value={description}
